...
const APPLE_PAY_CERTIFICATE_PATH = "./certificates/applepay.pem";  
const SSL_CERTIFICATE_PATH = "./certificates/sslcert.pem";
const SSL_KEY_PATH = "./certificates/sslkey.pem";	

const MERCHANT_IDENTIFIER = "merchant.myinnovation.bootcamp";
const MERCHANT_DOMAIN = "myinnovationbootcamp.com";
try {
...
app.post('/getApplePaySession', function (req, res) {
	...
	const options = {
		...
		body: {
			...
			displayName: 'Apple Wallet - Fiserv',
		},
		json: true,
    }
	...
	request(options, function(err, response, body) {
		if (err) {
			...
			console.log('Error generating Apple Pay session!' + err, response, body);
